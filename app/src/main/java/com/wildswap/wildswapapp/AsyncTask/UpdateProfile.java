...
public class UpdateProfile extends AsyncTask<String, String, String> {
    ...
    public UpdateProfile(Context context, String userType, String bio, String why, String profile_pic, String cover_pic, Boolean update, String token, AsyncResponse delegate) {
