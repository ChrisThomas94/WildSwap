 ...
 *
 */
public class FetchSomeUsers extends AsyncTask<String, String, String> {
    ...
    public FetchSomeUsers(Context context, ArrayList<String> emails, AsyncResponse delegate) {
    ...
    private String getAllUsers() {
        ...
        //    users.put(emails.get(i));
        //}

        return "{\"tag\":\"" + "someUsers" + "\","
                + "\"users\":\"" + users + "\"}";
    }
